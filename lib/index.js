...
exports.PayooPayment = void 0;
var crypto = require("crypto");
var moment = require("moment-timezone");
var node_fetch_1 = require("node-fetch");
var PayooPayment = /** @class */ (function () {
    function PayooPayment(_a) {
    ...
    PayooPayment.prototype.createOrderRequest = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (0, node_fetch_1.default)("".concat(this.endpointCheckout, "/v2/paynow/order/create"), {
                                method: 'POST',
    ...
    PayooPayment.prototype.createOrderXml = function (_a) {
    ...
    PayooPayment.prototype.createSHA512 = function (text) {
    ...
    PayooPayment.prototype.getDateValidity = function () {
        return moment()
            .add(1, 'days')
            .format('yyyyMMDDHHmmss'); //Request will get invalid after 1 hours
    };
    PayooPayment.prototype.verifyNotifyData = function (_a) {
        var ip = _a.ip, xml = _a.xml;
        return __awaiter(this, void 0, void 0, function () {
            var data, result, checksum;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    PayooPayment.prototype.verifyPayment = function (_a) {
    ...
    PayooPayment.prototype.refundPayment = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        checksumValue = _b.sent();
                        return [4 /*yield*/, (0, node_fetch_1.default)("".concat(this.endpointRefund, "/refund"), {
                                method: 'POST',
                                headers: {
...
exports.PayooPayment = PayooPayment;
